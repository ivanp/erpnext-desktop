...
This project is indexed by GitNexus as **erpnext-desktop** (1623 symbols, 4174 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
